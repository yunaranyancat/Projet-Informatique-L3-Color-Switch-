 ...
 *
 * EasyWriter provides simple methods for opening and writing to text files. All
 * exceptions are handled inside the class and are hidden from the user.
 *
 * <xmp>
 * Example: =======
 *
 * EasyWriter outFile = new EasyWriter("anyname.txt"); if (outFile.bad()) {
 * System.err.println("Can't create anyname.txt\n"); System.exit(1); }
 * outFile.print("2 + 2 = "); outFile.println(4); outFile.println(); // an extra
 * blank line outFile.close(); // optional
 * </xmp>
 *
 */
